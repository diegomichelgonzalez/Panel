        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Editando o perfil de... {{ $edit->name }}!</h5>
                                @can('admin')
            ...
            <div class="col-md-6 col-lg-6 order-2 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <h5 class="card-title">Mudar a foto do perfil</h5>
                        <div class="dropdown">
                    ...
                    <div class="card-body">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-5">
                                    <center>
                                        <img src="/uploads/{{$edit->image}}" alt="" class="w-px-150 h-uto rounded-circle" height="180"/>

                                    </center>    
                                </div>
                                <br>
                                <div class="col-md-7">
                                    <form class="form" action="/update-conta/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="image">Image de Perfil</label>
                                            <input type="file" id="image" name="image" class="from-control-file"/>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-warning">Mudar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-lg-6 order-2 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <i class="menu-icon tf-icons bx bx-grid"></i>
                        <h5 class="card-title m-0 me-2">Alterar informações pessoais</h5>
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="transactionID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                <i class="bx bx-dots-vertical-rounded"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="transactionID">
                                <a class="dropdown-item" href="/alter-senha/{{ $edit->id }}">Mudar a Senha</a>
